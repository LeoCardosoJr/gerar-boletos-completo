...
var Santander = (function () {
	...
	Santander.prototype.getLocaisDePagamentoPadrao = function () {
		return ['EVITE MULTAS POR ATRASO REALIZANDO PAGAMENTO EM QUALQUER BANCO, NA LOTÉRICA, NOS CANAIS DIGITAIS DO SEU BANCO (INTERNET BANKING) OU APP DE PAGAMENTO.'];
	};
