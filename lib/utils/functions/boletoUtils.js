...
var Avalista = (function () {
	function Avalista() {

	}

	Avalista.prototype.getNome = function () {
		return this._nome;
	};

	Avalista.prototype.comNome = function (_nome) {
		this._nome = _nome;
		return this;
	};

	Avalista.prototype.getIdentificacao = function () {
		var identificacao = this.getNome(),
			tipo = this.temRegistroNacional();
	...
	Avalista.prototype.getRegistroNacional = function () {
		return this._registroNacional;
	};

	Avalista.prototype.getRegistroNacionalFormatado = function () {
		return formatacoes.registroNacional(this._registroNacional);
	};

	Avalista.prototype.temRegistroNacional = function () {
		return validacoes.eRegistroNacional(this._registroNacional);
	};

	Avalista.prototype.comCNPJ = function (_cnpj) {
		this.comRegistroNacional(_cnpj);
		return this;
	};

	Avalista.prototype.comCPF = function (_cpf) {
		this.comRegistroNacional(_cpf);
		return this;
	};

	Avalista.prototype.comRegistroNacional = function (_registroNacional) {
		this._registroNacional = _registroNacional;
		return this;
	};

	Avalista.prototype.getDocumento = function () {
		return this._documento;
	};

	Avalista.prototype.comDocumento = function (_documento) {
		this._documento = _documento;
		return this;
	};

	Avalista.prototype.getEndereco = function () {
		return this._endereco;
	};

	Avalista.prototype.comEndereco = function (_endereco) {
		this._endereco = _endereco;
		return this;
	};

	Avalista.novoAvalista = function () {
		return new Avalista().comEndereco(Endereco.novoEndereco());
	};

	return Avalista;
})();

module.exports.Avalista = Avalista;
...
var Datas = (function () {
	...
	Datas.prototype.comDocumento = function (_documento,locate = 'usa') {
		if (locate === 'usa') {
			_documento = new Date (_documento  + ' GMT-3');
		}else if(locate === 'brl'){
	...
	Datas.prototype.comProcessamento = function (_processamento, locate = 'usa') {
		if (locate === 'usa') {
			_processamento = new Date (_processamento + ' GMT-3');
		}else if(locate === 'brl'){
	...
	Datas.prototype.comVencimento = function (_vencimento, locate = 'usa') {
		if(locate == 'usa'){
			_vencimento = new Date (_vencimento + ' GMT-3');
		}else if(locate == 'brl'){
...
var Boleto = (function () {
	...
	var NEW_DATA_BASE = new Date(2025, 2 - 1, 22);
	...
	Boleto.prototype.getFatorVencimento = function () {
		...
		var dataBase = vencimento >= NEW_DATA_BASE ? NEW_DATA_BASE : DATA_BASE;
		 
	    var diferencaEmDias = parseInt((vencimento - dataBase) / (1000 * 60 * 60 * 24));

		if (diferencaEmDias > 9999) {
			throw new Error('Data fora do formato aceito');
		}

		if (vencimento >= NEW_DATA_BASE) {
			diferencaEmDias = diferencaEmDias + 1000;
		}
	...
	Boleto.prototype.getAvalista = function () {
		return this._avalista;
	};

	Boleto.prototype.comAvalista = function (_avalista) {
		this._avalista = _avalista;
		return this;
	};
